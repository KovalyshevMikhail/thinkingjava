...
public class Exercise06 extends BaseExample{
	...
	public Exercise06(){
		...
		codeExample =
				...
				"System.out.println(\"Тест простой строки \"Привет!\" = \" + store.storage(\"Привет!\"));\n" +
				"\n" +
				"store.lastStorage = store.storage(\"По сложнее строка\");\n" +
				"System.out.println(\"Запишем результат от строки \"По сложнее строка!\" во внутреннюю переменную и выведем - \" + store.lastStorage);\n\n\n" +
